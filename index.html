    ...
    <body>
        ...
        <div class="container px-4 px-lg-5">
            ...
            <div class="card text-white bg-secondary my-5 py-4 text-center">
                <div class="card-body"><p class="text-white m-0">デジタル化を軸に、IT技術との連携により、製品やサービス、ビジネスモデルの変革を支援し顧客価値を高めます</p></div>
            </div>
            <!-- Content Row-->
            <div class="row gx-4 gx-lg-5">
                <div class="col-md-6 mb-5">
                    <div class="card h-100">
                        <div class="card-body">
                            <h2 class="card-title">システムビジネスモデリング(0→1)</h2>
                            <p class="card-text">デジタル技術を核とするビジネスをモデリングしその情報システム化を支援します。また必要に応じてそのシステムの差異化要素に関するプロト設計を行いお客様のPoCプロセスを支援します。</p>
                        </div>
                ...
                <div class="col-md-6 mb-5">
                    <div class="card h-100">
                        <div class="card-body">
                            <h2 class="card-title">プロジェクトマネジメント(1→10)</h2>
